...
class Config:
    def __init__(self):
        ...
        self.dataset_option = 'Foursquare' 
        ...
        self.lambda_kg = 0.1      
        self.lambda_cl = 0.2      
        self.lambda_rec = 2.0     # Slightly stronger reconstruction to recover Full-F1
        ...
        # Data Params
        self.max_seq_len = 21     # [USER REQUEST] Short Context21
        self.oot_seq_len = 10     # [ROLLBACK] 14 degraded full metrics on Yelp

        # Inference/Decoding Params (for one-by-one tuning)
        self.decode_temperature = 0.5#0.4 is good ,0.5 is a little worse;0.45 is a good balance for both datasets.
        self.decode_dist_penalty = 18.0#the best setting for distance penalty is 18.0.
        self.decode_hist_penalty = 5.0#5
        self.decode_last_penalty = 55.0#55
